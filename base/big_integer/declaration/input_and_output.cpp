...
big_integer::big_integer(const big_integer &number){
    ...
    this->integer_part=this->integer_part;
}
    ...
    try{
        if(isdigit(number[0])){
            ...
            for(int i=this->integer_length-1;i>=0;i--){
                if(isdigit(number[i])){ this->integer_part.push_back(number[i]-'0'); }
                else if(isupper(number[i])){ this->integer_part.push_back(number[i]-'A'+10); }
                else if(islower(number[i])){ this->integer_part.push_back(number[i]-'a'+10); }
                else{ throw "illegal_input"; }
            }
        }
        else if(number[0]=='-'){
